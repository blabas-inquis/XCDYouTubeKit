...
-(void)fillCircularLayer {
	...
	messageLabel.text = @"For the first time you need to login your gmail account, you shall be re-directed to Youtube. Afterwards, you can come back to app and continue using.";
